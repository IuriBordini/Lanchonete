		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">
					...
					<h3 class="visible-xs">Lanchonete</h3>
				</a>
			</div>
			...
			<div class="container">
						...
						<div class="box-item">
							...
							<div class="col-sm-6">
								<div class="wrapper">
									...
									<a class="btn btn-3" href="#">Compre já</a>
								</div>
							</div>
							<div class="clear"></div>
						</div>
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="box-item">
							<div class="col-sm-6">
								<div class="media"><img class="media__image " src="img/Fast_food_French_fries_Beer_Hamburger_Highball_524931_2560x1440.jpg">
								  <div class="media__body">
									<h2>R$28</h2>
									<p>Only</p>
								  </div>
					...
					<div class="col-xs-6">
						<div class="box-item">
							<div class="col-sm-6">
								<div class="media"><img class="media__image " src="images/4-thumb.jpg">
								  <div class="media__body">
									<h2>R$45</h2>
									<p>Only</p>
								  </div>
