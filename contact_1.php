		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="index.html#staff">Nosso CHEF</a>
                    </li>
					<li>
                        <a class="page-scroll" href="index.html#portfolio">Cardápio</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="index.html#booking">Fale conosco</a>
                    </li>
